...
class Web7ContainerCest
{
    ...
    public function cronTest(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec dev_web_7 apt list --installed | grep cron");
    ...
    public function mysqlClientTest(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec dev_web_7 apt list --installed | grep mysql-client");
    ...
    public function libreOfficeTest(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec dev_web_7 libreoffice --version");
    ...
    public function propplerUtilTest(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec dev_web_7 apt list --installed | grep poppler-util");
    ...
    public function zipTest(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec dev_web_7 zip -v");
    ...
    public function unzipTest(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec dev_web_7 unzip -v");
    ...
    public function phpunitTest(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec dev_web_7 phpunit --version");
        $I->seeInShellOutput('PHPUnit 5.7');
    }

    public function gitTest(AcceptanceTester $I){
        $I->wantTo("verify git is installed in the container");
        $I->runShellCommand("docker exec dev_web_7 git --version");
    ...
    public function curlTest(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec dev_web_7 curl --version");
    ...
    public function phpTest(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec dev_web_7 php --version");
    ...
    public function bowerTest(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec dev_web_7 bower --version");
        $I->seeInShellOutput('1');
    }

    public function bzip2Test(AcceptanceTester $I){
        $I->wantTo("verify bzip2 is installed in the container");
        $I->runShellCommand("docker exec dev_web_7 apt list --installed | grep bzip2");
    ...
    public function phpModuleTest(AcceptanceTester $I){
            ...
            $I->runShellCommand("docker exec dev_web_7 php -m");
            ...
            // $I->seeInShellOutput('ereg'); No longer available in PHP 7
    ...
    public function mysqlServerTest(AcceptanceTester $I){
            ...
            $I->runShellCommand("docker exec dev_web_7 ping db -c 2");
