...
class Web56ContainerCest
{
    ...
    public function apacheInstalledTest(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec dev_web_56 apache2 -v");
    ...
    public function libreOfficeTest(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec dev_web_56 libreoffice --version");
    ...
    public function propplerUtilTest(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec dev_web_56 apt list --installed | grep poppler-util");
    ...
    public function zipTest(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec dev_web_56 zip -v");
    ...
    public function unzipTest(AcceptanceTester $I){
        ...
        $I->runShellCommand("docker exec dev_web_56 unzip -v");
