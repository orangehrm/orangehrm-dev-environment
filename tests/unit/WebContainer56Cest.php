...
class WebContainer56Cest
{
    ...
    public function checkCronInstallation(UnitTester $I){
        ...
        $I->runShellCommand("docker exec qa_web_56 apt list --installed | grep cron");
    ...
    public function checkPHPModules(UnitTester $I){
            ...
            $I->runShellCommand("docker exec qa_web_56 php -m");
