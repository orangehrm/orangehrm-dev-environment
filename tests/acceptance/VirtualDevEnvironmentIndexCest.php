...
class VirtualDevEnvironmentIndexCest
{
    public function installationForDev56(AcceptanceTester $I)
    {
        ...
        $I->runShellCommand("docker exec dev_web_56 bash -c 'cd /var/www/html/OHRMStandalone/test/ && mkdir -p index-test.orangehrmdev.com/symfony/web && cd index-test.orangehrmdev.com/symfony/web && echo NewTestDirectory > index.html'");
        $I->runShellCommand('docker exec dev_web_56 bash -c "cd /var/www/html/OHRMStandalone/opensource/ && mkdir -p index-os.orangehrmdev.com && cd index-os.orangehrmdev.com && echo NewOsDirectory > index.html" ');
    ...
    {
        $I->comment("Create projects into test and opensource ");
        $I->runShellCommand("docker exec dev_web_70 bash -c 'cd /var/www/html/OHRMStandalone/test/ && mkdir -p index-test.orangehrmdev.com/symfony/web && cd index-test.orangehrmdev.com/symfony/web && echo NewTestDirectory > index.html'");
        $I->runShellCommand('docker exec dev_web_70 bash -c "cd /var/www/html/OHRMStandalone/opensource/ && mkdir -p index-os.orangehrmdev.com && cd index-os.orangehrmdev.com && echo NewOsDirector > index.html" ');
    ...
    {
        $I->comment("Create projects into test and opensource ");
        $I->runShellCommand("docker exec dev_web_71 bash -c 'cd /var/www/html/OHRMStandalone/test/  && mkdir -p index-test.orangehrmdev.com/symfony/web && cd index-test.orangehrmdev.com/symfony/web && echo NewTestDirectory > index.html'");
        $I->runShellCommand('docker exec dev_web_71 bash -c "cd /var/www/html/OHRMStandalone/opensource/ && mkdir -p index-os.orangehrmdev.com && cd index-os.orangehrmdev.com && echo NewOsDirectory > index.html" ');
