...
class VirtualDevEnvironmentIndexCest
{
    ...
    {
        $I->comment("Check the new development environment");
        ...
        $I->runShellCommand('docker exec dev_web_70 bash -c "curl -v -k -i https://index-test.orangehrmdev.com"');
        $I->runShellCommand('docker exec dev_web_70 bash -c "curl -v -k -i https://index-os.orangehrmdev.com"');
