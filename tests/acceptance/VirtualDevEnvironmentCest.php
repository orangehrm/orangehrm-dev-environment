...
class VirtualDevEnvironmentCest
{
    public function installApp(AcceptanceTester $I)
    {
        ...
        $I->runShellCommand("docker exec dev_web_56 bash -c 'cd /var/www/html/OHRMStandalone/test/ && mkdir orangehrm-test.orangehrmdev.com/symfony/web && cd orangehrm-test.orangehrmdev.com/symfony/web && echo test >> index.html'");
