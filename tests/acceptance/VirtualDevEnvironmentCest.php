...
class VirtualDevEnvironmentCest
{
    public function installApp(AcceptanceTester $I)
    {
        ...
        $I->runShellCommand("docker exec dev_web_56 bash -c 'mkdir -p /var/www/html/OHRMStandalone/test/orangehrm-test.orangehrmdev.com/symfony/web && cd /var/www/html/OHRMStandalone/test/orangehrm-test.orangehrmdev.com/symfony/web && echo test >> index.html && ll'");
